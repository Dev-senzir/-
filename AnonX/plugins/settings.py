...
async def settingsback_helper(
    ...
    if CallbackQuery.message.chat.type == "private":
        try:
            ...
            OWNER = None
        mention = "[" + CallbackQuery.from_user.first_name + "](tg://user?id=" + str(CallbackQuery.from_user.id) + ")"
        buttons = private_panel(_, app.username, OWNER)
        return await CallbackQuery.edit_message_text(
            f"""↯︙اهلا بك عزيزي انا بوت تشغيل موسيقى\n↯︙يمكنني تشغيل الموسيقى والفيديو في الاتصال\n↯︙استخدم الازرار لمعرفة اوامر المستخدم\n[•˛ َِ𝗗َِ𝗲َِ𝗩 َِ𝗦َِ𝗲َِ𝗡َِ𝘇َِ𝗜َِ𝗿 . ⚡,](https://t.me/IC_X_K)""",
            reply_markup=InlineKeyboardMarkup(buttons),
        )
    else:
        try:
